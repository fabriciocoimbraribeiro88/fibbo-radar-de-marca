...
export default function AvgLikesChart({ metrics }: Props) {
  const data = metrics.map((m) => ({ name: m.name, value: m.avgLikes, color: m.color }));
      ...
      <CardContent className="p-4">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={data} margin={{ top: 20, right: 10, left: 10, bottom: 5 }}>
            ...
            <Tooltip formatter={(v: number) => [v.toLocaleString("pt-BR"), "Média Likes"]} />
